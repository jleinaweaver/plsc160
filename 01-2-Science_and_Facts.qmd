...
1. I want you to review and then classify each submitted fact by your level of confidence: High, Moderate, Low or None
...
2. With scores in hand now go through and select a top-5 list (facts you are most confident in) and a bottom-5 (least confident in).
...
3. With your scores and rankings complete I now want you to step back and generalize from the exercise.
...
## Political "Science": Key Takeaways {background-image="Images/Background-Rally_v2.png" .center}

:::: {.incremental}
::: {.r-fit-text}
1. ALL facts are tenuous

2. Be humble in your knowledge

3. Science is never finished
:::
::::

::: notes

REVEAL: FIRST, ALL facts are tenuous and knowledge is constantly evolving
...
REVEAL: SECOND, be humble in your knowledge
...
REVEAL: FINALLY, we embrace science because it is a method for developing knowledge that is built on this idea of change

- SLIDE: Elaborate on third point
...
1. Baglione Chapter 1; 

2. Krippner (2000), 

3. Hoover Green (2013) and 

4. BRING TO CLASS: Research Article 1: Fortna, V. P., Lotito, N. J., & Rubin, M. A. (2018). Don’t Bite the Hand that Feeds: Rebel Funding Sources and the Use of Terrorism in Civil Wars. International Studies Quarterly, 62(4), 782–794
