...
3. Timings
    - Introduce the new concepts (theory, hypotheses and DAGs)
    - Groups design model of voting
    - Groups diagram research article model
...
*Mix up the groups! (aim for three groups in class)*
