...
2. IDEA: Don't worry about getting through all of the exercises. See where the students lock in and let that go
...
- **Why do some rebel groups resort to terrorism while others refrain from doing so?**

- **Baglione (2019)**: Interesting, Important, Controversial, Brief, Direct, Doable, Puzzling (optional)

- **Huntington-Klein (2022)**: Consider Potential Results, Feasibility, Scale, Design and Keep It Simple!
...
- Make two lists on the board: Strengths vs Weaknesses

- Classify the criteria under each list

<br>

Ok groups, lists made?

- Next step: I want each group to revise the RQ to address AT LEAST ONE of the "weaknesses"

- Write the new question on the board!

<br>

*SP26: All groups just narrowed the scope of the question, so you pushed them to revise again BUT this time focused EITHER on adding controversy or a puzzle element*

<br>

*PRESENT and DISCUSS each*

- **Which weakness(es) did you focus on and how did you address them?**
...
- **Why are authoritarian governments so enthusiastic about domestic surveillance? How does digital surveillance influence government behavior and citizen well-being?**
...
Revise the question: Select one of the weaknesses and address it
